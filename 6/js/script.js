...
class AccentTypographyBuild {
  ...
  createElement(letter) {
    ...
    this._timeOffset = Math.floor(Math.random() * 300);
    return span;
  }
...
/* harmony import */ var _onload__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./onload */ "./source/js/modules/onload.js");
...
class FullPageScroll {
  ...
  runAnimation(timeout = 0) {
    ...
    if (isLoaded) {
      _onload__WEBPACK_IMPORTED_MODULE_1__["animationArr"].forEach((item) => item.destroyAnimation());
      setTimeout(() => {
        _onload__WEBPACK_IMPORTED_MODULE_1__["animationArr"][this.activeScreen].runAnimation();
        this.footers.forEach((item) => item.classList.remove(`screen__footer--hidden`));
        this.disclaimer.classList.remove(`screen__disclaimer--hidden`);
      }, timeout);
    }
...
/*!*************************************!*\
  !*** ./source/js/modules/onload.js ***!
  \*************************************/
/*! exports provided: introAnimation, sliderAnimation, prizesAnimation, rulesAnimation, gameAnimation, animationArr, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "introAnimation", function() { return introAnimation; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rulesAnimation", function() { return rulesAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gameAnimation", function() { return gameAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animationArr", function() { return animationArr; });
/* harmony import */ var _animation_builder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animation-builder */ "./source/js/modules/animation-builder.js");


const introAnimation = new _animation_builder__WEBPACK_IMPORTED_MODULE_0__["AccentTypographyBuild"](`.intro__title`, 500, `animate`, `transform`);
const sliderAnimation = new _animation_builder__WEBPACK_IMPORTED_MODULE_0__["AccentTypographyBuild"](`.slider__item-title`, 500, `animate`, `transform`);
const prizesAnimation = new _animation_builder__WEBPACK_IMPORTED_MODULE_0__["AccentTypographyBuild"](`.prizes__title`, 500, `animate`, `transform`);
const rulesAnimation = new _animation_builder__WEBPACK_IMPORTED_MODULE_0__["AccentTypographyBuild"](`.rules__title`, 500, `animate`, `transform`);
const gameAnimation = new _animation_builder__WEBPACK_IMPORTED_MODULE_0__["AccentTypographyBuild"](`.game__title`, 500, `animate`, `transform`);

const animationArr = [introAnimation, sliderAnimation, prizesAnimation, rulesAnimation, gameAnimation];
    ...
    if (((window.innerWidth / window.innerHeight) < 1) || window.innerWidth < 769) {
      ...
      storySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](`.js-slider`, {
        ...
        on: {
          slideChange: () => {
            [2, 4, 6].forEach((item) => {
              body.classList.remove(`slide-${item}`);
            });
            if (storySlider.activeIndex !== 0) {
              body.classList.add(`slide-${storySlider.activeIndex}`);
            }
            if (storySlider.activeIndex === 0) {
